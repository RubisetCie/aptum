...
constexpr std::initializer_list<binary> binaries{
   binary{
	 ...
	 command{
	    {"list"},
	    {
	       ...
	       {'s', "no-description", "APT::Cache::NoDesc", "Don't output description", 0},
	 ...
	 command{
	    {"search"},
	    {
	       {'i', "installed", "APT::Cache::Installed", "Print only installed packages", 0},
	       {'l', "lib", "APT::Cache::Libs", "Print only library packages", 0},
	       {'d', "devel", "APT::Cache::Devel", "Print only devel packages", 0},
	       {0, "debug", "APT::Cache::Debug", "Print only debug packages", 0},
	       {0, "doc", "APT::Cache::Doc", "Print only doc packages", 0},
	       {0, "kernel", "APT::Cache::Kernel", "Print only kernel packages", 0},
	       {0, "admin", "APT::Cache::Admin", "Print only admin packages", 0},
	       {'n', "names-only", "APT::Cache::NamesOnly", "Only search names", 0},
	       {'s', "no-description", "APT::Cache::NoDesc", "Don't output description", 0},
	    },
	 },
	 command{
   ...
   binary{
	 ...
	 command{
	    {"search"},
	    {
	       {'i', "installed", "APT::Cache::Installed", "Print only installed packages"},
	       {'l', "lib", "APT::Cache::Libs", "Print only library packages"},
	       {'d', "devel", "APT::Cache::Devel", "Print only devel packages"},
	       {0, "debug", "APT::Cache::Debug", "Print only debug packages"},
	       {0, "doc", "APT::Cache::Doc", "Print only doc packages"},
	       {0, "kernel", "APT::Cache::Kernel", "Print only kernel packages"},
	       {0, "admin", "APT::Cache::Admin", "Print only admin packages"},
	       {'n', "names-only", "APT::Cache::NamesOnly", "Only search names"},
	       {'s', "no-description", "APT::Cache::NoDesc", "Don't output description"},
	 ...
	 command{
	    {"history"},
	    {
	       {'f', "full", "APT::Cache::ShowFull", "Show the full history"},
	    },
	 },
	 command{
   ...
   binary{
	 ...
	 command{
	    {"install"},
	    {
	       {'a', "architecture", "APT::Get::Host-Architecture", "Install for specific architecture", CommandLine::HasArg},
	       {0, "lib", "APT::Get::Libs", "Install the libraries related to devel packages", 0},
	    },
	 },
	 command{
	    {"upgrade"},
	 ...
	 command{
	    {"save", "load"},
	    {
	       {0, "load", "APT::Save::Load", "Load a saved state", 0},
	       {'l', "list", "APT::Save::List", "List the saved states", 0},
	       {'d', "delete", "APT::Save::Delete", "Delete a saved state", 0},
	       {0, "diff", "APT::Save::Diff", "Show the diff between current and saved state", 0},
	       {0, "purge", "APT::Get::Purge", "Use purge instead of remove", 0},
	    },
	 },
	 command{
	 ...
	 {'R', "install-recommends", "APT::Install-Recommends", "Install recommended packages", CommandLine::Boolean},
